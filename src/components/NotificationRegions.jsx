export default function NotificationRegions({ regions }) {
  return (
    <section>
      <h2 className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-600 mb-6">
        Region Filtering
      </h2>
      <div className="space-y-3">
        {regions.map((region) => (
          <div
            key={region.name}
            className="flex items-center justify-between p-3 bg-slate-900 rounded-xl border border-white/5"
          >
