function HeroSection() {
  return (
    <section className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-slate-900 via-slate-900 to-blue-900/20 px-6 py-20 text-center">
      ...
      <h1 className="text-5xl md:text-6xl lg:text-7xl font-black text-white mb-6 leading-tight max-w-4xl">
        AI-Powered Flood <br />
