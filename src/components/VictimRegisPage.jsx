      ...
      <div className="mx-auto max-w-6xl px-6 py-12">
        ...
        <section className="mb-12">
          ...
          <p className="max-w-3xl text-gray-400 text-lg leading-relaxed">
            Please provide accurate identification and family details. This data
            is transmitted via
            <span className="text-white font-medium"> Secure Protocol</span> to
            rescue teams for immediate action.
          </p>
        </section>
              ...
              <div className="rounded-4xl border border-white/5 bg-slate-800/50 p-8 shadow-2xl backdrop-blur-sm">
                <form className="space-y-10" onSubmit={handleSubmit}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="group">
                        ...
                        <div className="relative">
                          <User className="absolute left-5 top-1/2 -translate-y-1/2 h-5 w-5 text-gray-500 group-focus-within:text-blue-400" />
                          <input
                            required
                            type="text"
                            placeholder="e.g. Muhammad Ahmed"
                            className="w-full h-14 rounded-2xl border border-gray-700 bg-[#0F172A] px-4 pl-14 text-gray-100 outline-none focus:border-blue-500 transition-all leading-none box-border"
                          />
                        </div>
                      </div>
                      ...
                      <div className="group">
                        ...
                        <div className="relative">
                          <CreditCard className="absolute left-5 top-1/2 -translate-y-1/2 h-5 w-5 text-gray-500 group-focus-within:text-blue-400" />
                          <input
                            required
                            type="text"
                            placeholder="42101-XXXXXXX-X"
                            className="w-full h-14 rounded-2xl border border-gray-700 bg-[#0F172A] px-4 pl-14 text-gray-100 outline-none focus:border-blue-500 transition-all font-mono leading-none box-border"
                          />
                        </div>
                      </div>
                      ...
                      <div className="group">
                        ...
                        <div className="relative">
                          <Phone className="absolute left-5 top-1/2 -translate-y-1/2 h-5 w-5 text-gray-500 group-focus-within:text-blue-400" />
                          <input
                            required
                            type="tel"
                      ...
                      <div className="group">
                        ...
                        <div className="relative">
                          <Mail className="absolute left-5 top-1/2 -translate-y-1/2 h-5 w-5 text-gray-500 group-focus-within:text-blue-400" />
                          <input
                            required
                            type="email"
                  ...
                  <div className="space-y-6 pt-10 border-t border-white/5">
                    ...
                    <div className="space-y-4">
                      {familyMembers.map((member, index) => (
                        <div
                          key={index}
                          className="grid grid-cols-1 md:grid-cols-12 gap-4 bg-black/20 p-4 rounded-2xl border border-white/5 items-center"
                        >
                  ...
                  <div className="space-y-10 pt-10 border-t border-white/5">
                    <div className="group">
                      <label className="block text-[10px] uppercase tracking-[0.4em] text-gray-500 font-bold mb-4">
                        Last Known Location / Address
                      </label>
                      <div className="relative">
                        <MapPin className="absolute inset-y-0 left-5 flex h-5 w-5 items-center text-gray-400" />
                        <input
                          required
                          type="text"
                          placeholder="e.g. Sector 4-B, Indus District"
                          className="w-full h-14 rounded-[20px] border border-gray-700 bg-[#0F172A] px-4 pl-14 text-gray-100 outline-none focus:border-blue-500 transition-all"
                        />
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
                        {[
                          ...
                          >
                            <item.icon
                              className={`h-6 w-6 ${lossTypes.includes(item.label) ? "text-blue-400" : ""}`}
                            />
                    ...
                    <div className="p-6 rounded-3xl bg-red-500/5 border border-red-500/10">
                      ...
                      <div className="flex flex-wrap gap-3">
                        {[
                          ...
                          <label
                            key={need}
                            className="flex items-center gap-2 bg-[#0F172A] border border-gray-800 px-4 py-3 rounded-xl cursor-pointer hover:border-red-500/30 transition-all"
                          >
                            <input
                              type="checkbox"
                              className="w-4 h-4 rounded border-gray-700 bg-slate-900 text-blue-500 focus:ring-0"
                            />
                  ...
                  <div className="flex flex-col md:flex-row items-center justify-between gap-6 pt-10 border-t border-white/5">
                    <p className="text-[10px] text-gray-500 max-w-xs leading-relaxed italic">
                      By clicking submit, you confirm that all information is
                      correct as per government records.
                    </p>
                    <button
                      type="submit"
                      className="group relative w-full md:w-auto bg-blue-500 hover:bg-blue-400 text-slate-950 font-black py-5 px-16 rounded-2xl text-[11px] uppercase tracking-[0.3em] shadow-[0_0_30px_rgba(59,130,246,0.3)] transition-all active:scale-95 overflow-hidden"
                    >
          ...
          <aside className="space-y-6">
            <section className="rounded-4xl border border-white/5 bg-slate-800/50 p-6 shadow-2xl backdrop-blur-sm relative overflow-hidden">
              ...
              <p className="text-xs text-gray-400 leading-relaxed mb-6">
                Registration will be timestamped and geolocated. Ensure your
                phone's GPS is enabled for satellite sync.
              </p>
