...
const NGOPortal = () => {
  ...
  return (
    <motion.div
      className="flex h-screen w-full bg-[#05070a] text-slate-100 overflow-hidden font-sans"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
        ...
        <div className="p-6 mt-auto">
          <div className="glass-panel p-4 rounded-[24px] flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-slate-800 border border-white/10 flex-shrink-0 overflow-hidden">
              <img
                src="https://api.dicebear.com/7.x/shapes/svg?seed=NGO"
                alt="User"
              />
            </div>
        ...
        >
          <div className="flex items-center gap-6">
            <button
              ...
              className="md:hidden p-3 bg-white/5 rounded-2xl text-slate-400 hover:text-sky-400 transition-all"
            >
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[10px] font-bold text-sky-500/60 mt-1 uppercase">
          ...
          <div className="flex items-center gap-8">
            <div className="hidden lg:flex items-center gap-3 glass-panel px-6 py-3 rounded-2xl focus-within:ring-1 ring-sky-500/30 transition-all">
              ...
              <input
                ...
                className="bg-transparent border-none text-[9px] font-bold outline-none w-56 uppercase tracking-[0.2em] placeholder:text-slate-700"
              />
            </div>
...
const InputField = ({ label, placeholder, icon, value, onChange }) => (
  <div className="space-y-3">
    ...
    <div className="relative group">
      <div className="absolute left-6 top-1/2 -translate-y-1/2 text-slate-700 group-focus-within:text-sky-500 transition-colors">
        {icon}
      </div>
      <input
        value={value}
  ...
  <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in zoom-in-95 duration-700">
    <div className="flex items-center gap-6 mb-16">
      ...
      <div>
        ...
        <p className="text-[10px] text-slate-600 uppercase font-black tracking-[0.4em] mt-2">
    ...
    {[1, 2, 3].map((i) => (
      <div
        key={i}
        className="glass-panel p-10 rounded-[50px] relative group hover:bg-white/[0.02] transition-all"
      >
