...
function AlertsFeedPage() {
  ...
  return (
    <div className="flex min-h-screen bg-slate-950 text-white lg:pl-72">
      ...
      >
        <motion.section
          className="bg-gradient-to-br from-slate-900 via-slate-800 to-cyan-950/30 border-b border-slate-700 px-8 py-14 shadow-2xl shadow-cyan-500/10"
          variants={itemVariants}
        >
          <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
            <div className="max-w-2xl">
              <p className="text-xs text-cyan-300 uppercase tracking-widest font-bold mb-4">
                REAL-TIME SITUATIONAL AWARENESS
              </p>
              <h1 className="text-4xl md:text-5xl font-black mb-4 leading-tight text-white">
                Active Flood <span className="text-cyan-400">Intelligence</span>
              </h1>
              <p className="text-slate-300 text-lg leading-relaxed">
                Live weather-driven assessments use Open-Meteo forecasts with
                rule-based rainfall thresholds to raise or clear automated
                flood-risk alerts. Editorial briefings appear alongside for
                context.
              </p>
            </div>
            <motion.aside
              className="rounded-[32px] border border-slate-700 bg-slate-900/90 p-6 shadow-2xl shadow-cyan-500/10 w-full max-w-md"
              variants={itemVariants}
            ...
            >
              ...
              <button
                className="w-full py-3 px-4 bg-blue-600 hover:bg-blue-700 text-white font-bold uppercase text-xs rounded-3xl transition-colors"
                type="button"
          ...
          <div className="mt-10 rounded-[32px] border border-slate-700 bg-slate-900/95 p-5 shadow-xl shadow-cyan-500/10">
        ...
        <motion.section className="px-8 py-8" variants={itemVariants}>
          <div className="grid grid-cols-12 gap-8 mb-8">
            ...
            <motion.div
              className="col-span-12 lg:col-span-4 bg-slate-800/80 backdrop-blur-xl rounded-[32px] border border-slate-700 p-6 shadow-xl shadow-cyan-500/10"
              variants={itemVariants}
            >
              <p className="text-xs text-slate-400 uppercase tracking-widest font-bold mb-4">
                OVERVIEW
